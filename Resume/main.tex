...
\section{Selected Publications (The first three have been implemented in MotionGen 2024)}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item{\textbf{(Accepted) Data-Driven Design using Differentiable Physics: Sampling Density for Reliable Initialization into Basin of Attraction, ASME IDETC/CIE, 2026}{\\ Authors: \textbf{ \emph{Zhijie Lyu}}, Suhas Gangireddy, Anurag Purwar}
    {\\ \small{\begin{itemize}
