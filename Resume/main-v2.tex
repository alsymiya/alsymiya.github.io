...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Stony Brook University -- SUNY}{January 2020 -- Present}
    ...
    \resumeSubheading
      ...
      {Bachelor in Mechanical Engineering, Mechantronic Direction}{Sichuan, Chengdu, PRC}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Topics: Robotics, Computer-Aided Design, Machine Learning, Analysis of Algorithms, Advanced Dynamics, Vibration and Control, Computer Vision, Artificial Intelligence}
      \resumeItemListEnd
    
    \resumeSubheading
      {Ph.D. Research}{January 2020 -- Present}
      {Some for Machine Learning, some for Mathematical Data Structure, and most for Algorithms}{}
      \resumeItemListStart
        \resumeItem{Journal Publication Record: $4/6$ as first author. One featured article for JMD. } 
        \resumeItem{Journal Review Record: multiple manuscripts from ASME-JMD, ASME-JMR and IEEE-THMS}
      \resumeItemListEnd

    \resumeSubheading
    {Teaching Assistant}{January 2020 -- Present}
    {Worked as TA for four undergraduate courses}{}

    \resumeSubheading
    {Academic Presentation}{August 2022, 2023, 2024, and 2025}
    {Participated in four ASME IDETC/CIE}{}

    \resumeSubheading
    {Software Development (Funded by NSF and Mechanismic Inc.)}{May 2019 -- Present}
    {Development and Evaluation of \href{motiongen.io}{MotionGen} }{}
    \resumeItemListStart
        \resumeItem{Display: implemented customizable shape elements on the canvas using paper.js (2019 -- 2020) }
        \resumeItem{Fast Kinematic Solver: \\ Cooperated on a unified, generalizable, and efficient planar linkage simulator using approximation (2022); \\ Extended the simulation capability using an extended Pebble Game framework (2024 -- 2025)}
        \resumeItem{Mechanism Synthesis Pipeline: Designed a common mathematical data structure for the geared linkage mechanisms; Generated a massive mechanism dataset for these mechanisms; Deployed a backend server using Google Cloud and a VAE-based pipeline; Reduced the storage of the same mechanism information data to $1/100$ of its original in the code base, and reduced the query time with the use of customized topology dictionary; Deployed the G-manifold algebraic fitting method for motion synthesis. (2022 -- 2025)}
        \resumeItem{Impact: The number of registered users is approximately $88,000$ as of August 2025 since it had a registration system in 2022. A sharp increase in user registration occurred in August 2023 when a popular mechanism design channel Engineezy used our application to design a mechanism prototype. } \resumeItemListEnd
...
\section{Technical Skills, Language Skills, and Interests}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Familiar Technologies}{: PyTorch, Matplotlib, Numpy, CUDA, Node.js, React-Redux} \\
     \textbf{Writing}{: \LaTeX, Office} \\
     \textbf{Languages}{: Cantonese (native), Mandarin Chinese (native), English (fluent)} \\
     \textbf{Interests}{: Software Development, Applied Math Science, Machine Learning, Document Translation, Speedrunning in video games} \\ 
    }}
 \end{itemize}
...
%-----------PUBLICATIONS-----------
\newpage
\section{Journal Publications (The first three have been implemented in MotionGen 2024)}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
    ...
    \item{\textbf{A Dataset of 3M Single-DOF Planar 4-, 6-, and 8-bar Linkage Mechanisms with Open and Closed Coupler Curves for Machine Learning-Driven Path Synthesis, ASME Journal of Mechanical Design (Special Issue for IDETC-CIE 2024)}{\\ Authors: Anar Nurizada, Rohit Dhaipule, \emph{\textbf{Zhijie Lyu}}, Anurag Purwar}
        ...
        \item This dataset, together with a compact kinematic structure library, is implemented onto MotionGen using Google Cloud API with the synthesis method presented in the second publication. 
    \end{itemize}}}
    }
    ...
    \item{\textbf{(Accepted) Construction, Reduction, and Decomposition of Planar Mechanisms via an Extended Pebble Game Framework}{\\ Authors: \textbf{\emph{Zhijie Lyu}}, Anurag Purwar}
        {\\ \small{\begin{itemize}
